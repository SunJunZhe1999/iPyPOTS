...
from pypots.imputation.uniformtsv import UniFormTSV
from pypots.nn.functional import calc_mae, calc_mse, calc_rmse, calc_mre


def train_and_evaluate_uniformtsv(dataset: dict, args) -> Tuple[float, float, float, float]:
    print("🚀 Starting UniFormTSV training pipeline...")
    ...
    print(f"[UniFormTSV] Testing —— MAE: {mae:.4f}| MSE: {mse:.4f}| RMSE: {rmse:.4f}| MRE: {mre:.4f}| ")
