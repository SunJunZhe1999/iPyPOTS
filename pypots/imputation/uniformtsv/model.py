"""
The implementation of UniFormTSV (MOMENT clone) for the partially-observed time-series imputation task.
...
class UniFormTSV(BaseNNImputer):
    """The PyTorch implementation of the UniFormTSV model :cite:`goswami2024moment`.
