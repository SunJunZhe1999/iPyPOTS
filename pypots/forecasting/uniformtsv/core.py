"""
The core wrapper assembles the submodules of UniFormTSV forecasting model
...
from ...nn.modules.uniformtsv import BackboneUniFormTSV
from ...nn.modules.saits import SaitsEmbedding


class _UniFormTSV(ModelCore):
    def __init__(
        self,
        n_steps: int,
        n_features: int,
