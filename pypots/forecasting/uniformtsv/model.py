"""
The implementation of UniFormTSV (MOMENT clone) for the partially-observed time-series forecasting task.
...
class UniFormTSV(BaseNNForecaster):
    """The PyTorch implementation of the UniFormTSV forecasting model :cite:`goswami2024moment`.
